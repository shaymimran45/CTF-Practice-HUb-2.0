...
export default function PwnProblemsPage() {
  ...
  useEffect(() => {
    async function loadProblems() {
      try {
        const data = await getProblemsByCategory("pwn");
        setProblems(data);
      } catch (error) {
        console.error("Failed to load pwn problems:", error);
      } finally {
        setLoading(false);
      }
    }
  ...
  const categoryName = categoryNames["pwn"] || "pwn";
  ...
  return (
    <div className="min-h-screen py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-gradient-to-r from-yellow-600 to-amber-500 rounded-xl shadow-lg p-8 mt-8 text-white">
          <h2 className="text-2xl font-bold mb-4">Binary Exploitation Learning Path</h2>
          <p className="text-xl text-gray-200 mb-6">
            Start with basic buffer overflows and progress to advanced exploitation techniques.
          </p>
