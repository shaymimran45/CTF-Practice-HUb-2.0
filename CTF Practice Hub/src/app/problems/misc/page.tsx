...
export default function MiscProblemsPage() {
  ...
  useEffect(() => {
    async function loadProblems() {
      try {
        const data = await getProblemsByCategory("misc");
        setProblems(data);
      } catch (error) {
        console.error("Failed to load misc problems:", error);
      } finally {
        setLoading(false);
      }
    }
  ...
  const categoryName = categoryNames["misc"] || "misc";
  ...
  return (
    <div className="min-h-screen py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-gradient-to-r from-pink-600 to-rose-500 rounded-xl shadow-lg p-8 mt-8 text-white">
          <h2 className="text-2xl font-bold mb-4">Miscellaneous Learning Path</h2>
          <p className="text-xl text-gray-200 mb-6">
            Explore diverse challenges that don't fit into traditional categories.
          </p>
