...
export default function ReversingProblemsPage() {
  ...
  useEffect(() => {
    async function loadProblems() {
      try {
        const data = await getProblemsByCategory("reversing");
        setProblems(data);
      } catch (error) {
        console.error("Failed to load reversing problems:", error);
      } finally {
        setLoading(false);
      }
    }
  ...
  const categoryName = categoryNames["reversing"] || "reversing";
  ...
  return (
    <div className="min-h-screen py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                  ...
                  {problems.map((problem, index) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        <Link 
                          href={`/problems/reversing/${problem.id}`}
        ...
        <div className="bg-gradient-to-r from-blue-600 to-cyan-500 rounded-xl shadow-lg p-8 mt-8 text-white">
          <h2 className="text-2xl font-bold mb-4">Reverse Engineering Learning Path</h2>
          <p className="text-xl text-gray-200 mb-6">
            Start with simple binaries and progress to complex protections and obfuscation.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white bg-opacity-10 rounded-lg p-4">
              <h3 className="text-lg font-semibold mb-2">Beginner</h3>
              <ul className="list-disc pl-5 space-y-1 text-sm">
                <li>Simple C Programs</li>
